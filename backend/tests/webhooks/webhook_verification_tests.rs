...
fn test_verify_gitea_signature_valid() {
    ...
    let result = verify_webhook_signature(&ProviderType::Gitea, &expected_sig, body, secret);
...
fn test_verify_gitea_signature_invalid() {
    ...
    let result = verify_webhook_signature(&ProviderType::Gitea, wrong_signature, body, secret);
...
fn test_verify_signature_empty_secret() {
    ...
    let result = verify_webhook_signature(&ProviderType::Gitea, signature, body, secret);
...
fn test_verify_signature_case_sensitivity() {
    ...
    let result = verify_webhook_signature(&ProviderType::Gitea, &uppercase_sig, body, secret);
