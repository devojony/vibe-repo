...
This specification defines the simplified task execution model for VibeRepo v0.4.0-mvp. The system stores only the most recent execution log inline, removes detailed execution history tracking, and simplifies failure handling.
