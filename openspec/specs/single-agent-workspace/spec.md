...
This specification defines the single-agent-per-workspace model for VibeRepo v0.4.0-mvp. Each workspace has exactly one agent configuration, simplifying agent management and task assignment.
